...
- [3. Sistema proposto](#3-sistema-proposto)
	...
	- [3.2 Requisiti non funzionali](#33-requisiti-non-funzionali)
	- [3.3 Modelli del sistema](#34-modelli-del-sistema)
		- [3.3.1 Casi d'uso](#341-casi-duso)
		...
		- [3.3.2 Modello degli oggetti](#342-modello-degli-oggetti)
			- [Lista delle classi](#lista-delle-classi)
			- [Diagramma delle entity](#diagramma-delle-entity)
			- [Diagramma delle classi](#diagramma-delle-classi)
		- [3.3.3 Modello dinamico](#343-modello-dinamico)
		...
		- [3.3.4 Interfaccia utente: navigazione e mock-up](#344-interfaccia-utente-navigazione-e-mock-up)
			- [Login](#login)
