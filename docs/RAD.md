...
3. Il DBMS comunica al sistema i dati.
	4. Il sistema chiede all'utente di compilare un form dove
	   verranno definite le caratteristiche della visita.
5. L'utente inserisce le informazioni che il sistema richiede.
