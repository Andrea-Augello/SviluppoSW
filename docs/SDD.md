...
-___Application Logic___ >> include tutti gli oggetti control ed entity controllando, così, le funzionalità di un'applicazioni eseguendo 	                       elaborazioni dettagliate.  
-___External component comunication, DBMS, MailServer___  >> 	livello che gestisce i dati che sono necessari al funzionamento dell’intero sistema. Questi risiedono in un DataBase.  	  	
