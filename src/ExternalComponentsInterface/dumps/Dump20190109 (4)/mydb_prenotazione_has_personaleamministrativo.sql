...
--
-- Table structure for table `prenotazione_has_personaleamministrativo`
--

DROP TABLE IF EXISTS `prenotazione_has_personaleamministrativo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `prenotazione_has_personaleamministrativo` (
...
--
-- Dumping data for table `prenotazione_has_personaleamministrativo`
--

LOCK TABLES `prenotazione_has_personaleamministrativo` WRITE;
/*!40000 ALTER TABLE `prenotazione_has_personaleamministrativo` DISABLE KEYS */;
/*!40000 ALTER TABLE `prenotazione_has_personaleamministrativo` ENABLE KEYS */;
UNLOCK TABLES;
