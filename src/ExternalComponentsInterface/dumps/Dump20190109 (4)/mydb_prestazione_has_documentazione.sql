...
--
-- Table structure for table `prestazione_has_documentazione`
--

DROP TABLE IF EXISTS `prestazione_has_documentazione`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `prestazione_has_documentazione` (
...
--
-- Dumping data for table `prestazione_has_documentazione`
--

LOCK TABLES `prestazione_has_documentazione` WRITE;
/*!40000 ALTER TABLE `prestazione_has_documentazione` DISABLE KEYS */;
/*!40000 ALTER TABLE `prestazione_has_documentazione` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-01-09 14:46:27
