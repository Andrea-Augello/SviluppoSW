...
--
-- Table structure for table `prenotazione_has_personalemedico`
--

DROP TABLE IF EXISTS `prenotazione_has_personalemedico`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `prenotazione_has_personalemedico` (
...
--
-- Dumping data for table `prenotazione_has_personalemedico`
--

LOCK TABLES `prenotazione_has_personalemedico` WRITE;
/*!40000 ALTER TABLE `prenotazione_has_personalemedico` DISABLE KEYS */;
/*!40000 ALTER TABLE `prenotazione_has_personalemedico` ENABLE KEYS */;
UNLOCK TABLES;
